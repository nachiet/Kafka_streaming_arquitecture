...
public class SalesSummary extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SalesSummary\",\"namespace\":\"com.farmia.sales\",\"fields\":[{\"name\":\"category\",\"type\":\"string\"},{\"name\":\"total_quantity\",\"type\":\"int\"},{\"name\":\"total_revenue\",\"type\":\"float\"},{\"name\":\"window_start\",\"type\":{\"type\":\"long\",\"connect.name\":\"org.apache.kafka.connect.data.Timestamp\",\"connect.version\":1,\"logicalType\":\"timestamp-millis\"}},{\"name\":\"window_end\",\"type\":{\"type\":\"long\",\"connect.name\":\"org.apache.kafka.connect.data.Timestamp\",\"connect.version\":1,\"logicalType\":\"timestamp-millis\"}}]}");
...
static {
  ...
  private static final BinaryMessageEncoder<SalesSummary> ENCODER =
      new BinaryMessageEncoder<SalesSummary>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SalesSummary> DECODER =
      new BinaryMessageDecoder<SalesSummary>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<SalesSummary> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SalesSummary>(MODEL$, SCHEMA$, resolver);
  }
